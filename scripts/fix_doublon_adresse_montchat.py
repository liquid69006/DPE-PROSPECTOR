...
# Variante MONTCHAT : meme logique generique (dedup cle exacte / meme bgid),
# chemins re-pointes. Aucune adresse curee DL n'intervient dans l'algo.
LIGHT = ROOT / "data" / "secteur_montchat_light.json"
BAK = ROOT / "data" / "secteur_montchat_light.json.predoublon.bak"
